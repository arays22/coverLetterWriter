...
public class writeMyLetter {
	...
	String cover = "Dear [name]: I’m writing in response to your recently advertised "
			...
			+ "[insert personal characteristics] professional who [add more information "
			+ "on how you can add value to future company]. (You can insert short "
			+ "version of your career profile here).Enclosed is my resume "
			+ "that more fully details my background and work experience, and "
			+ "how they relate to your position. As you can see, [pick out a "
			+ "few key details or experiences that align with the specific "
			+ "requirements of the advertised role].I firmly believe that I can "
